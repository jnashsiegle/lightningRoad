...
@endsection <!--end of title section-->					
					<div class="row-fluid">					
	                	<div class = "col-md-6 flex1">
	                		<!--<h1 class = "lHeader hidden-xs hidden-sm text-left">L<span style="font-family: thequietscream">i</span>ghtn<span style="font-family: thequietscream">i</span>ng Road</h1>--><img src = "../images/textLogoLight.svg" class = "lHeader hidden-xs hidden-sm align-left alt = "Lightning Road Biker Outreach" />
	                		<small class = "tagline hidden-xs hidden-sm">B<span style="font-family: thequietscream">i</span>ker Outreach | Motorcycle Evangelism</small>
	                	</div>
	                	<div class = "col-md-6 flex2">                		
	                		<img src = "../images/textLogoLight.svg" class = "center-block .img-responsive hidden-md hidden-lg hidden-xl" >
	                		<img src = "../images/alphaLogo.svg" class = "hidden-sm hidden-xs center-block .img-responsive" alt = "Lightning Road Biker Outreach Logo">
	                		<blockquote>
		...
		<div class = "row-fluid">
        	...
        	<div id = "information" class="container-fluid"><!--footer-->
           		<div class = "row-fluid"> 
       		 	...
       		 	<div class = "row-fluid">
       		 	<div class = "col-md-4">				
					<img src = "../images/alphaLogo.svg" class = "pullL .img-responsive" alt = "Lightning Road Biker Outreach Logo">
				</div>				
				<div class = "col-md-4">
				...
				<div class = "col-md-4">										
						<a href = "https://www.facebook.com/sozosam/"><i class="fa fa-5x fa-facebook-official center-icon pullR" aria-hidden="true"></i></a>
				</div>
			</div><!--end row fluid-->
			<div class = "row-fluid clearfix">
				<div class = "col-md-12">
					<ul class = "credits">
						<li class = "text-muted pullL">Site by&colon; <a href = "jlsdesk.com">LightPoint Development</a></li>

...
@endsection <!--end of title section-->					
					<div class="row-fluid">					
	                	...
	                	<div class = "col-md-6 flex2">                		
	                		...
	                		<img src = "../images/boltLogo.svg" class = "hidden-sm hidden-xs center-block .img-responsive" alt = "Lightning Road Biker Outreach Logo">
	                		<blockquote>
	...
	<div id = "what" class = "container-fluid"> <!--What We Do section -->
		...
		<div id = "mission" class = "container-fluid"> <!--Mission section -->
			...
			<div class = "row-fluid">
				<div class = "col-xs-12">
					<img src = "../images/Day of Champions_HCJC.jpg" class = "img-responsive pullL gapR" alt = "Day of Champions">
						<div class = "statement">
						...
						<p class = "text-left">WITNESSING to ANYONE desiring spiritual guidance through the Word of God, living example, and preaching.</p>
							...
							<h5>We endeavor to reach out to anyone who is hurting in a lost and desperate world.</h5>
							<cite>~(Phil 2&colon;15)</cite>
							</div>
		...
		<div id = "contact" class = "container-fluid"> <!--Contact section -->
			...
			<div class = "col-md-12">
				<div class = "verse pullL hidden-sm hidden-xs">
						<h5>Join us as we attack the spirit of lack, defeat, despair, doubt, and unbelief through the uncompromising Word of God.</h5>
						<cite>~&lpar;Isaiah 6&colon;1&dash;&rpar;</cite>
				</div>
				<div class = "verse pullR hidden-sm hidden-xs">
						<h5>Expect change in your life, and choose this day to walk in the fullness of His blessing!</h5>
						<cite>~&lpar;Gal 3&colon;14&rpar;</cite>
				</div>

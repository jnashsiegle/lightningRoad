...
<!--end of #About-->
<div id="what" class="container-fluid">
    <!--What We Do section -->
    <!--breadcrumbs-->
    <nav class="breadcrumb">
        <a class="breadcrumb-item" href="#">Home / </a>
    ...
    <div class="row-fluid">
        <div class="col-md-12 clearfix text-center">
            <a href="#contact">
                <section class="cta">
                    <h2 class="cta center-block">Be a mentor.</h2>
                    <h3 class="cta center-block">Do what Jesus commanded us to do.</h3>
                </section>
            </a>
            <hr>
        </div>
        <!--col-md-12 clearfix text-center-->
    </div>
    <!--end of row-fluid-->
    <div class="row-fluid">
        <div class="col-md-12 clearfix">
            <aside class="hcenter verse pullR gapR">
                <!--the following divs style the verse-->
                <div class="innerBox center-block">
                    <div class="vtext">
...
@endsection @include('partials.contact') @section('content1')
...
<footer id="information" class="container-fluid print">
    <!--footer-->
    <div class="row-fluid">
        <div class="navbar" role="navigation">
            <ul class="nav navbar-nav">
                <li class="col-xs-4 col-md-2 text-center"><a href="#landing">Back To Top</a>
                </li>
                <li class="col-xs-4 col-md-2 text-center"><a href="#about">About Us</a>
                </li>
                <li class="col-xs-4 col-md-2 text-center"><a href="#what">What We Do</a>
                </li>
                <li class="col-xs-4 col-md-2 text-center"><a href="#mission">Mission Statement</a>
                </li>
                <li class="col-xs-4 col-md-2 text-center"><a href="#contact">Request Information</a>
                </li>
                <li class="col-xs-4 col-md-2 text-center"><a href="#gallery">Our Journey</a>
                </li>
            </ul>
        </div>
        <!--end navbar-->
